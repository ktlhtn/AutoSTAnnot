...
After the recording location is selected, the recording of the videos starts. Since the aim is to determine the location and time of different sound sources in the same recording, we will cover different object in the same video clips. These objects can be adults talking, kid crying, dog barking, bird singing and so on.
