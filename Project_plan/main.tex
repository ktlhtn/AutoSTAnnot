...
% as the second.
\title{Signal Processing Innovation Project, Project Plan}{Signal Processing Innovation Project, Project Plan}
...
\input{tex/project_background.tex}

\chapter{Project Organisation}
\label{ch:project_organisation}
\input{tex/project_organisation.tex}

\chapter{Project Objectives}
\label{ch:project_objectives}
\input{tex/project_objectives.tex}
...
\chapter{Budget}
\label{ch:budget}
\input{tex/budget.tex}

\chapter{Project Management}
\label{ch:project_management}
\input{tex/project_management.tex}
